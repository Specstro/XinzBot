...
//------------------< Math Random >-------------------
                ...
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					...
					xinz.sendImage(from, await getBuffer(`https://i.ibb.co/30526/bf84f20635dedd5dde31e7e5b6983ae9.jpg`), 'Dare\n\n' + der , msg)
					break
...
*Hasil Pencarian : ${q}*\n`
               ...
               case prefix+'tiktok': case prefix+'tiktoknowm': {
                ...
                reply(mess.wait)
                axios.get(`https://api-specstor.herokuapp.com/api/tiktod/?url=${args[1]}&apikey=Alphabot`)
                .then(({data}) => {
                console.log(data)
...
//------------------< Stalker >-------------------
            case prefix+'igstalk': case prefix+'stalkig':{
                ...
                reply(mess.wait)
                axios.get(`https://api-specstor.herokuapp.com/api/ig/stalk?username${args[1]}&apikey=Alphabot`)
                .then(({data}) => {
